...
public class RailwayCrossingServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        crossingDAO = new RailwayCrossingDAO(connection);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equals("delete"))
        {
            ...
            response.sendRedirect(request.getContextPath() + "/railway-crossing");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("railwayList.jsp").forward(request, response);
    }
